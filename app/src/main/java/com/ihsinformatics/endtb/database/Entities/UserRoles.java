...
public class UserRoles {
    ...
    @Generated(hash = 1663854961)
    private transient UserRolesDao myDao;

    @Generated(hash = 168440292)
    public UserRoles(Long id, Long userId, Long roleId, Boolean voided) {
        this.id = id;
        this.userId = userId;
        this.roleId = roleId;
        this.voided = voided;
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 348879107)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getUserRolesDao() : null;
    }
